...
EXPECTED_COMMIT = "8a9dba6615448c1ad85c44cdf89269a8fc3e00e8"
EXPECTED_BUILD = "0054"
EXPECTED_CANDIDATE = "RC4"
EXPECTED_PATH_COUNT = 82
MANIFEST_PATH = "Documentation/Build_Records/0054/ASSET_INTENT_MANIFEST.json"
DELIVERY_PATH = "Documentation/Build_Records/0054/CANDIDATE_DELIVERY.json"
...
def derive(
    ...
    if str(predecessor.get("build_number")) != EXPECTED_BUILD:
        raise RuntimeError("predecessor manifest build_number is not 0054")
    if str(predecessor.get("candidate")) != EXPECTED_CANDIDATE:
        raise RuntimeError("predecessor candidate is not RC4")
    ...
    if delivery_result.returncode == 0:
        ...
        if observed_candidate and observed_candidate != EXPECTED_CANDIDATE:
            raise RuntimeError("Build 0054 delivery evidence does not identify RC4")

    result = {
        "schema_version": "1.0.0",
        "generated_at": datetime.now(timezone.utc).isoformat(),
        "source": "CANONICAL_GIT_OBJECTS",
        "predecessor_build": "0054",
        "predecessor_candidate": "RC4",
        ...
        "withdrawn_candidates": ["RC1", "RC2", "RC3"],
        "blobs": blobs,
