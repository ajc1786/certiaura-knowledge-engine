...
EXPECTED_PATH_COUNT = 89
MANIFEST_PATH = "Documentation/Build_Records/0055/ASSET_INTENT_MANIFEST.json"
DELIVERY_PATH = "Documentation/Build_Records/0055/CANDIDATE_DELIVERY.json"
...
def derive(
    ...
    if str(predecessor.get("build_number")) != EXPECTED_BUILD:
        raise RuntimeError("predecessor manifest build_number is not 0055")
    ...
    if delivery_result.returncode == 0:
        ...
        if observed_candidate and observed_candidate != EXPECTED_CANDIDATE:
            raise RuntimeError("Build 0055 delivery evidence does not identify RC2")
