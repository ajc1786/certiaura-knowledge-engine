    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            with zipfile.ZipFile(package) as zf:
                zf.extractall(root)
            manifest = json.loads((root / "Documentation/Build_Records/0060/ASSET_INTENT_MANIFEST.json").read_text(encoding="utf-8"))
            ...
            validator = root / "13_Project_Genesis/Validators/validate_bpc157_transition.py"
            ...
            tests = run([sys.executable, "-B", "-m", "unittest", "discover", "-s", "13_Project_Genesis/Tests", "-p", "test_build_0060_*.py", "-v"], cwd=root)
