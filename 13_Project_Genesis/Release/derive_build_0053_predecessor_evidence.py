...
EXPECTED_COMMIT = "d5b7b84a2c543bbdd5cad8727f1c9005c27ca70d"
EXPECTED_BUILD = "0053"
EXPECTED_CANDIDATE = "RC4"
EXPECTED_PATH_COUNT = 83
MANIFEST_PATH = "Documentation/Build_Records/0053/ASSET_INTENT_MANIFEST.json"
DELIVERY_PATH = "Documentation/Build_Records/0053/CANDIDATE_DELIVERY.json"
...
def derive(
    ...
    if str(predecessor.get("build_number")) != EXPECTED_BUILD:
        raise RuntimeError("predecessor manifest build_number is not 0053")
    ...
    if delivery_result.returncode == 0:
        ...
        if observed_candidate and observed_candidate != EXPECTED_CANDIDATE:
            raise RuntimeError("Build 0053 delivery evidence does not identify RC4")

    result = {
        "schema_version": "1.0.0",
        "generated_at": datetime.now(timezone.utc).isoformat(),
        "source": "CANONICAL_GIT_OBJECTS",
        "predecessor_build": "0053",
