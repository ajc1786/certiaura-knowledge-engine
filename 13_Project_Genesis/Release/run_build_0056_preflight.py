...
def main() -> int:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            validator = root / "13_Project_Genesis/Validators/validate_tesamorelin_pilot.py"
            ...
            tests = run([sys.executable, "-B", "-m", "unittest", "discover", "-s", "13_Project_Genesis/Tests", "-p", "test_build_0056_*.py", "-v"], cwd=root)
