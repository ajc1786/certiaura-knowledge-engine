...
def main() -> int:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp:
            ...
            validator = root / "13_Project_Genesis/Validators/validate_tesamorelin_workflow_simulation.py"
            ...
            tests = run([sys.executable, "-B", "-m", "unittest", "discover", "-s", "13_Project_Genesis/Tests", "-p", "test_build_0057_*.py", "-v"], cwd=root)
