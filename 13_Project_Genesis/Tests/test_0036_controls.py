...
class TestControls(unittest.TestCase):
 ...
 def test_readme_boundary(self): self.assertIn('may not determine legal eligibility',self.text('Documentation/Build_Records/0036/BUILD_0036_READ_ME_FIRST.md'))
 def test_no_parallel(self): self.assertIn('Do not create a parallel',self.text('Documentation/Build_Records/0036/BUILD_0036_READ_ME_FIRST.md'))
 def test_numbering_decision(self): self.assertIn('Close the 0035 lettered sequence',self.text('Documentation/Build_Records/0036/DECISION_RECORD_0036.md'))
