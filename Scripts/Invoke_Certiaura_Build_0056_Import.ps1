...
$Script = Join-Path $PSScriptRoot "..\13_Project_Genesis\Import\run_build_0056_import.py"
...
if ($LASTEXITCODE -ne 0) { throw "Build 0056 import failed with exit code $LASTEXITCODE." }
