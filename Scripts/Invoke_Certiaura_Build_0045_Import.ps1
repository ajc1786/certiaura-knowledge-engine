...
$Args=@((Join-Path $PSScriptRoot "import_certiaura_build_0045.py"),"--repository",$Repository,"--report",$Report)
...
if($LASTEXITCODE -ne 0){throw "Build 0045 import control failed."}
