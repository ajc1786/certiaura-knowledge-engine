...
$Script = Join-Path $PSScriptRoot "..\13_Project_Genesis\Import\run_build_0057_import.py"
...
if ($LASTEXITCODE -ne 0) { throw "Build 0057 import failed with exit code $LASTEXITCODE." }
