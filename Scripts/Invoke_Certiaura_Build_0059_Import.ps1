...
$Script = Join-Path $PSScriptRoot "..\13_Project_Genesis\Import\run_build_0059_import.py"
...
if ($LASTEXITCODE -ne 0) { throw "Build 0059 import failed with exit code $LASTEXITCODE." }
