...
BUILD="0045"; RECORD="Documentation/Build_Records/0045"; MANIFEST=RECORD+"/ASSET_INTENT_MANIFEST.json"
...
def main():
 ...
 if classified!=set(names): errors.append("Every package file must be classified exactly once")
 ...
 result={"valid":not errors,"build_number":BUILD,"package_file_count":len(names),"roots":roots,"ascii_only_powershell":not any("PowerShell" in e for e in errors),"repository_text_hygiene":not any(x in e for e in errors for x in ("BOM","Non-LF","whitespace","newline")),"external_backup_only":True,"errors":errors}
