...
$Script = Join-Path $PSScriptRoot "..\13_Project_Genesis\Import\run_build_0058_import.py"
...
if ($LASTEXITCODE -ne 0) { throw "Build 0058 import failed with exit code $LASTEXITCODE." }
